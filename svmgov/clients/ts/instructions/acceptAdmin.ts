...
>(
  input: AcceptAdminAsyncInput<TAccountNewAdmin, TAccountGlobalConfig>,
...
export function getAcceptAdminInstruction<
  ...
  TProgramAddress extends Address = typeof SVMGOV_PROGRAM_ADDRESS,
>(
  input: AcceptAdminInput<TAccountNewAdmin, TAccountGlobalConfig>,
  config?: { programAddress?: TProgramAddress },
): AcceptAdminInstruction<
  TProgramAddress,
  TAccountNewAdmin,
...
>(
  ...
  return {
    ...
    accounts: { newAdmin: getNextAccount(), globalConfig: getNextAccount() },
